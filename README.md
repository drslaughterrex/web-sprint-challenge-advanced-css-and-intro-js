...
Accessability is the design and production of products so people with disabilities can use them.
...
A variable is a value that can change, depending on conditions or information passed to the program they are assigned to.
